...
export default function DiagnosticoNoEncontrado() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-bg-dark px-4 text-center">
      ...
      <div className="relative">
        ...
        <h1 className="mt-6 text-xl font-bold text-white">
          Este diagnóstico no existe
        </h1>
        <p className="mx-auto mt-2 max-w-sm text-sm text-text-muted">
          El enlace es incorrecto o el diagnóstico todavía no se ha publicado.
          Verifica la dirección con quien te lo compartió.
        </p>

        <Link
          href="/"
          className="group mt-6 inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-primary to-primary-hover px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/30 transition-all hover:shadow-xl hover:shadow-primary/40 active:scale-[0.98]"
        >
          Ir al inicio
