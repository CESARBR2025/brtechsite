// Datos públicos de la empresa: una sola fuente para footer, contacto,
// botón de WhatsApp, metadatos y datos estructurados (JSON-LD).

export const SITIO_URL = "https://www.brtechds.com"

export const EMPRESA = {
  nombre: "BR TECH Digital Systems",
  descripcion:
...
const WHATSAPP_MENSAJE = "Hola, me interesa una consulta para mi negocio."

export const WHATSAPP = {
  telefono: `+${WHATSAPP_NUMERO}`,
  visible: "427 201 1625",
  url: `https://wa.me/${WHATSAPP_NUMERO}?text=${encodeURIComponent(WHATSAPP_MENSAJE)}`,
  // Glifo oficial (Simple Icons)
